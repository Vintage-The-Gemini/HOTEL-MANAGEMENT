...
const mockQuotations = [
  ...
  { 
    id: 'Q-002', 
    reference: 'Q-GLO-2304-0002',
    client: { name: 'Globex Inc', email: 'bookings@globex.com' }, 
    createdAt: '2023-05-14', 
    amount: 8200.75,
    status: 'ACCEPTED',
    validUntil: '2023-05-21'
  },
  { 
    id: 'Q-003', 
    reference: 'Q-STK-2304-0003',
                    ...
                    {filteredQuotations.map((quotation) => (
                      <tr key={quotation.id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-900">
                          ...
                          <div className="text-gray-500">{quotation.client.email}</div>
                        </td>
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                          ...
                          >
                            View<span className="sr-only">, {quotation.reference}</span>
                          </Link>
                        </td>
                      </tr>
                    ))}

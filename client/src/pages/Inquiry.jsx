...
const Inquiry = () => {
  const [form, setForm] = useState({
    name: '', email: '', phone: '', checkIn: '', checkOut: '', guests: '1', roomType: '', message: ''
  });
  ...
  if (submitted) {
    return (
      <div className="max-w-xl mx-auto bg-white shadow-xl rounded-lg p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">Thank you for your inquiry. Our team will get back to you shortly.</p>
        <button 
    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
          ...
          <p className="text-indigo-100">Tell us about your stay requirements</p>
        </div>
